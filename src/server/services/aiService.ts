...
export const RICIS_SYSTEM_INSTRUCTION = `
...
export async function processAiChat(message: string, history: any[], language?: string): Promise<string> {
  const contents: any[] = [];
...
export async function processGroupWishes(wishes: any[]): Promise<any> {
